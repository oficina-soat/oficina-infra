...
locals {
  ...
  microservice_public_route_services = {
    ...
    "GET /api/v1/ordens-servico/{ordemServicoId}/orcamento-link"  = "oficina-billing-service"
    "POST /api/v1/ordens-servico/{ordemServicoId}/orcamento-link" = "oficina-billing-service"
    ...
    "POST /api/v1/orcamentos/{orcamentoId}/notificacao/reenvio"   = "oficina-billing-service"
